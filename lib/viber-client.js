...
ViberClient.prototype.setWebhook = function(url, isInline, sendName, sendPhoto) {
	this._logger.info("Sending 'setWebhook' request for url: %s, isInline: %s, sendName: %s, sendPhoto: %s", url,
	 isInline, sendName, sendPhoto);
